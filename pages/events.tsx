...
const DEMO_EVENTS: Discussion[] = [
  ...
  // Vietnamese Student Association Events
  {
    ...
    user_id: '3',
    title: 'VSA Lunar New Year Celebration 2025! 🎊',
    content: 'Celebrate Tết with the Vietnamese Student Association! Traditional food, lion dance performance, games, and cultural activities. Everyone is welcome to join us!',
    category: 'events',
    status: 'pinned',
    views: 287,
    reply_count: 24,
  ...
  },
  {
    ...
    user_id: '4',
    title: 'VSA Weekly Game Night - Jackbox & Board Games',
    content: 'Join VSA for our weekly game night! We play Jackbox, board games, and card games. Snacks provided. Great way to de-stress and make friends!',
    category: 'events',
    status: 'active',
    views: 156,
    reply_count: 9,
  ...
  },
  {
    ...
    user_id: '13',
    title: 'Vietnamese Student Association: Phở Night Fundraiser',
    content: 'Authentic Vietnamese phở made by VSA members! $8 per bowl, all proceeds go to community service projects. Vegetarian options available. Come hungry!',
    category: 'events',
    status: 'active',
    views: 189,
    reply_count: 21,
  ...
  // Add a TBD date event
  {
    ...
    updated_at: new Date(Date.now() - 216000000).toISOString(),
    user_id: '17',
    title: 'VSA Cultural Exchange Dinner - Spring Semester',
    content: 'Join us for a cultural exchange dinner featuring Vietnamese cuisine and traditions. Date and location to be announced soon. Sign up for notifications!',
    category: 'events',
    status: 'active',
    views: 87,
    reply_count: 5,
