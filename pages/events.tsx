...
const DEMO_EVENTS: Discussion[] = [
  ...
  // Academic & Career Events
  {
    ...
    updated_at: new Date(Date.now() - 561600000).toISOString(),
    user_id: '13',
    title: 'Career Fair - Engineering & Technology Companies',
    content: 'Meet recruiters from 50+ companies including Google, Microsoft, John Deere, and more! Bring resumes, dress professionally. Great opportunity for internships and full-time positions!',
    category: 'events',
    status: 'pinned',
    views: 412,
    reply_count: 35,
    ...
    downvotes: 3,
    vote_score: 86,
    event_date: new Date(Date.now() + 432000000).toISOString().split('T')[0], // 5 days
    event_time: '10:00 AM',
    event_end_time: '4:00 PM',
    event_location: 'Hilton Coliseum',
    author_username: 'career_services', author_name: 'ISU Career Services',
  },
  {
    id: 'e16',
    ...
    user_id: '16',
    title: 'Hackathon 2025 - Build, Code, Win!',
    content: '24-hour coding marathon! Form teams, build innovative projects, compete for $5000 in prizes. Free food, energy drinks, and swag. Sponsored by local tech companies.',
    category: 'events',
    status: 'active',
    views: 298,
    reply_count: 42,
    ...
    downvotes: 4,
    vote_score: 63,
    event_date: new Date(Date.now() + 1209600000).toISOString().split('T')[0], // 14 days
    event_time: '6:00 PM',
    event_end_time: '6:00 PM', // Next day
    event_location: 'Gerdin Business Building',
    author_username: 'hackisu', author_name: 'HackISU Team',
  },
  {
    id: 'e17',
    created_at: new Date(Date.now() - 1468800000).toISOString(),
    updated_at: new Date(Date.now() - 734400000).toISOString(),
    user_id: '17',
    title: 'Mental Health Awareness: Yoga & Meditation Session',
    content: 'Free yoga and guided meditation session. All experience levels welcome! Bring a mat or towel. Hosted by Student Wellness. Learn stress management techniques for exam season.',
    category: 'events',
    status: 'active',
    views: 187,
    reply_count: 16,
    ...
    event_time: '5:30 PM',
    event_end_time: '7:00 PM',
    event_location: 'State Gym, Studio 2',
    author_username: 'student_wellness', author_name: 'ISU Wellness',
  },
